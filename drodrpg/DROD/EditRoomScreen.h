// $Id: EditRoomScreen.h 9187 2008-08-29 13:34:30Z mrimer $
...
//	void     UniquePlacement(const UINT wX, const UINT wY, const MONSTERTYPE eType);
	...
	UINT              wSelKeyType;     //key currently selected
	UINT              wSelSwordType, wSelShieldType, wSelAccessoryType;   //equipment types selected
