...
enum MID_CONSTANT {
  ...
  MID_ForceArrowDisabled = 1874,
  MID_ForceArrowDisabledN = 1875,
  MID_ForceArrowDisabledE = 1876,
  MID_ForceArrowDisabledS = 1877,
  MID_ForceArrowDisabledW = 1878,
  MID_ForceArrowDisabledNW = 1879,
  ...
  MID_MoreCommands = 2035,
  MID_SaveGame = 2036,
  MID_LoadGame = 2037,
  MID_QuickSave = 2038,
  MID_QuickLoad = 2039,
  MID_SkipSpeech = 2040,
  MID_Command_OpenChat = 2041,
  MID_Command_ChatHistory = 2042,
  MID_Command_Screenshot = 2043,
  MID_Command_SaveRoomImage = 2044,
  MID_Command_ShowHelp = 2045,
  MID_Command_OpenSettings = 2046,
  MID_Command_ToggleFullScreen = 2047,
  MID_Command_ToggleTurnCount = 2048,
  MID_Command_ToggleHoldVars = 2049,
  MID_Command_ToggleFrameRate = 2050,
  MID_Command_EditVars = 2051,
  MID_Command_LogVars = 2052,
  MID_Command_ReloadStyle = 2053,
  MID_Command_Editor_Cut = 2054,
  MID_Command_Editor_Copy = 2055,
  MID_Command_Editor_Paste = 2056,
  MID_Command_Editor_Undo = 2057,
  MID_Command_Editor_Redo = 2058,
  MID_Command_Editor_Delete = 2059,
  MID_Command_Editor_PlaytestRoom = 2060,
  MID_Command_Editor_ReflectX = 2061,
  MID_Command_Editor_ReflectY = 2062,
  MID_Command_Editor_RotateCW = 2063,
  MID_Command_Editor_SetFloorImage = 2064,
  MID_Command_Editor_SetOverheadImage = 2065,
  MID_Command_Editor_ToggleCharacterPreview = 2066,
  MID_Command_Editor_PrevLevel = 2067,
  MID_Command_Editor_NextLevel = 2068,
  MID_Command_Editor_LogVarRefs = 2069,
  MID_Command_Editor_HoldStats = 2070,
  MID_Command_Editor_LevelStats = 2071,
  ...
  MID_MusicPirates = 1899,
  MID_MusicGoblinKing = 1900,
  MID_MusicBigSerpent = 1901,
  MID_MusicTar = 1902,
  MID_MusicPuzzle = 1903,
  MID_MusicSecretArea = 1904,
  MID_MusicSmallerPlans = 1905,
  MID_MusicGeometry = 1906,
  MID_MusicSlipStair = 1907,
  MID_MusicSympathetic = 1908,
  MID_MusicAscendant = 1909,
  MID_MusicRoachesRun = 1910,
  ...
  MID_MusicAmbDrips = 1917,
  MID_MusicAmbRoaches = 1918,
  ...
  MID_WaitForItemGroup = 1952,
  MID_WaitForNotItemGroup = 1953,
  MID_PlainFloor = 1954,
  MID_RegularWall = 1955,
  MID_BreakableWall = 1956,
  MID_AnyWallType = 1957,
  MID_StairsGroup = 1958,
  MID_TrapdoorGroup = 1959,
  MID_FallingTile = 1960,
  MID_PlatformOrRaft = 1961,
  MID_OpenDoor = 1962,
  MID_ClosedDoor = 1963,
  MID_SolidOTileGroup = 1964,
  MID_AnyArrow = 1965,
  MID_TarstuffGroup = 1966,
  MID_Briars = 1967,
  MID_HealthGroup = 1968,
  MID_AttackUpGroup = 1969,
